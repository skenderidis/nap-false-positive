            ...
            <div class="modal-body results" >
               ...
               <form class="row g-3">
                  ...
                  <div class="col-md-6 blocking_form vars">
                     <label class="form-label">Description</label>
                     <input type="text" class="form-control blocking_form" id="violation_form_description" >
                  </div>
      
                  <div class="col-md-2 blocking_form vars" style="text-align:center" >
         ...
         .done(function(msg) {
            if(msg.completed_successfully)
            {
               ...
               if(msg.warnings.length>0)
               {
                  ...
                  $("#change_results_general").append("<h7 style='color:orange'>The window will reload in 2 seconds</h7><br>");
            ...
            else
            {
               if("error_message" in msg )
               {
                  $("#change_results_general").append("<h6> Parsing error:<span style='color:red'> "+msg.error_message+"</span>. </h6>");
               }
            }           
         })
         .fail(function(jqXHR, textStatus, Status) {
