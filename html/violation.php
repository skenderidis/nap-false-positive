												...
												<table id="general" class="table table-striped " style="width:100%" <?php if ($error) echo 'hidden'; ?>>
													...
													<tbody>
														...
														<tr>
															...
															<td colspan=3><b><?php echo implode("<br>", $json_data["sig_ids"]); ?></b></td>
														</tr>											
														<tr>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
      	...
      	<div class="modal-body" style="margin-top: -20px;">
				...
				<form class="row g-3">
					<div class="col-md-6">
						<label class="form-label">Policy to Modify</label>
					...
					<div class="col-md-6 violation_form vars">
					...
					<div class="col-md-2 violation_form_block vars form-check" style="text-align:center">
					...
					<div class="col-md-2 violation_form_alarm vars form-check" style="text-align:center">
					...
					<div class="col-md-3 ip_form vars">
					...
					<div class="col-md-3 parameter_location_form vars">
					...
					<div class="col-md-3 parameter_valuetype_form vars">
					...
					<div class="col-md-3 static_value_add vars">
					...
					<div class="row" style="margin-top: 15px;margin-left: -15px;">
						<div class="col-md-3 multipleof_form vars">
							<label class="form-label">MultipleOf</label>
							<input type="text" class="form-control" id="multipleof_form">
						</div>
						<div class="col-md-2 multipleof_form_check vars form-check" style="text-align:center">
						...
						<div class="col-md-3 numeric_value_detected vars">
						...
						<div class="col-md-3 numeric_value_expected vars">
						...
						<div class="col-md-2 numeric_value_check vars form-check" style="text-align:center">
						...
						<div class="col-md-2 numeric_value_check_exclusive vars form-check" style="text-align:center">
